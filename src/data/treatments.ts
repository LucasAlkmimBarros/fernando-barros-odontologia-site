export const treatments = [
  ...
  { name: 'Limpeza e profilaxia', description: 'Manutenção da saúde bucal' },
  { name: 'Extrações', description: 'Remoção segura de dentes' },
  { name: 'Placas para bruxismo', description: 'Proteção contra desgaste dentário' },
  { name: 'Prótese Removível', description: 'Dentadura, roach e prótese de silicone flexível' }
] as const